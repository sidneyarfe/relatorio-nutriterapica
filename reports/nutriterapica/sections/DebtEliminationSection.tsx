        ...
        <div className="relative flex flex-col items-center gap-8">
          <ScrollReveal delay={0.2}>
            <div className="relative inline-block group">
              <span className={`text-4xl md:text-6xl font-light text-red-500 transition-all duration-1000 ${animate ? 'opacity-70' : 'opacity-100'}`}>
                R$ 2.161.185,27
              </span>
              <div className={`absolute top-1/2 left-0 h-1 bg-red-600 shadow-[0_0_15px_rgba(220,38,38,0.8)] transition-all duration-[1.5s] ease-in-out delay-500`} style={{ width: animate ? '100%' : '0%' }} />
            </div>
          </ScrollReveal>

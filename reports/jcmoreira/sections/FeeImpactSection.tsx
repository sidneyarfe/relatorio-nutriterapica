...
const FeeImpactSection: React.FC = () => {
  const protectedWealth = 894151.93;
  const feeValue = 134122.79;
  const netResult = protectedWealth - feeValue;
  const realImpactPercentage = (feeValue / protectedWealth) * 100;
  ...
  return (
    <section className="py-24 px-4 bg-[#080808] relative border-t border-white/5 overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <ScrollReveal>
          <SectionHeader 
            title="Você investe apenas R$ 134 mil por não ter perdido +R$ 894 mil"
            subtitle={`Resultando em proteção real de R$ ${netResult.toLocaleString('pt-BR', { minimumFractionDigits: 2 })} do seu patrimônio.`}
            centered
          />
        </ScrollReveal>
              ...
              <GlassCard className="h-full p-8 border-white/5 bg-neutral-900/30 flex flex-col justify-between relative overflow-hidden group hover:bg-white/5 transition-colors">
                 ...
                 <div>
                    ...
                    <div className="space-y-2 relative z-10">
                        <p className="text-neutral-400 text-xs uppercase tracking-wider">Honorários Totais (Atuação + Êxito)</p>
                        <p className="text-3xl lg:text-4xl font-mono text-white tracking-tight font-light">R$ 134.122,79</p>
                    </div>
                 </div>

                 <div className="mt-8 pt-6 border-t border-white/5 relative z-10">
                    <p className="text-sm text-neutral-400 leading-relaxed">
                       Remuneração pela defesa estratégica integral, garantindo a anulação da autuação e proteção do fluxo de caixa atualizado.
                    </p>
                 </div>
              </GlassCard>
            </ScrollReveal>
                    ...
                    <div className="space-y-6">
                        ...
                        <div>
                            <div className="flex justify-between text-[10px] uppercase tracking-wider font-bold mb-3">
                                <span className="text-gold flex items-center gap-1.5">
                                    ...
                                    Patrimônio Protegido (Corrigido)
                                </span>
                                <span className="text-white font-mono text-xs">R$ 894.151,93</span>
                            </div>
                        ...
                        <div className="flex items-start gap-3 mt-6 bg-green-500/5 p-4 rounded-lg border border-green-500/10">
                            ...
                            <p className="text-neutral-300 text-sm leading-relaxed">
                                O investimento em honorários representa apenas <strong className="text-white">15%</strong> do proveito econômico real garantido pela decisão do TJPA, já corrigido pela Selic.
                            </p>
                        </div>
...
export default FeeImpactSection;

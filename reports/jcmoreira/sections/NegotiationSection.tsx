          ...
          <GlassCard className="px-8 pt-10 pb-8 md:px-12 md:pt-12 md:pb-8 h-fit border-gold/30 bg-gradient-to-br from-neutral-900/90 to-gold/5 overflow-hidden relative">
            ...
            <div className="flex flex-col items-center text-center">
                ...
                <p className="text-neutral-400 max-w-lg mb-8 leading-relaxed">
                    O valor referente aos honorários de êxito (<span className="text-white font-mono">R$ 134.122,79</span>) encontra-se pendente de liquidação. Entre em contato diretamente com o sócio responsável para alinhar os detalhes finais.
                </p>

                <a 
                    href="https://wa.me/5591981160842?text=Desejo%20regularizar%20os%20honor%C3%A1rios%20do%20caso%20J.C.%20Moreira." 
                    target="_blank" 
